      ...
      <section className="mx-auto max-w-3xl px-6 pb-16">
        <ol className="space-y-10">
          {[
            {
              title: "Informieren",
              text: "Voraussetzungen, Mitgliedsbeiträge und Satzung werden nach Freigabe durch Neuer Tag veröffentlicht.",
            },
            {
            ...
            },
            {
              ...
              text: "Ein eingereichter Antrag wird vom Verein Neuer Tag geprüft. Eine Mitgliedschaft wird durch das Ausfüllen eines Formulars nicht automatisch bestätigt.",
            },
          ].map((step, i) => (
