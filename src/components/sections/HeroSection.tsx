...
import { Arrow, BrandMark } from "../ui/arrow";
    ...
    <section className="shell pb-14 pt-12 md:pb-20 md:pt-16">
      <div className="grid items-center gap-10 lg:grid-cols-[1fr_1.05fr] lg:gap-16">
        <div className="relative py-3">
          ...
          <p className="mt-7 max-w-md text-base leading-7 text-ink">
        ...
        <div className="relative pb-6 pr-3 sm:pr-5">
          ...
          <div className="absolute -left-3 bottom-0 flex -rotate-3 items-center gap-4 rounded-2xl bg-sage px-6 py-5 shadow-sm sm:-left-6">
            <BrandMark className="h-10 w-10 text-forest" />
          ...
          <BrandMark className="absolute right-3 top-8 h-20 w-20 rotate-12 text-orange sm:h-24 sm:w-24" />
        </div>
      </div>
