...
const notice='Beispielinhalt zur Gestaltung der Website. Angebote und Angaben müssen vor der Veröffentlichung als echtes Anahitasangebot bestätigt werden.';
const specs=[
...
for(const [, , , ,file,alt] of specs){
 const filename=`Anahita-example-${file}`;
...
news.forEach(([slug,title,excerpt],i)=>docs.push({_id:`example-news-${slug}`,_type:'newsArticle',title,slug:{_type:'slug',current:slug},excerpt,coverImage:images[specs[i][4]],categories:['Beispielbeitrag'],content:body('Dieser Beitrag ist ein redaktionelles Beispiel, keine aktuelle Anahitasmeldung.',excerpt,'Eine Gemeinschaft lebt von Menschen, die zuhören, Ideen teilen und gemeinsam etwas gestalten. An dieser Stelle können später freigegebene Geschichten aus dem Anahitasleben erscheinen.'),publishedAt:'2026-09-01T09:00:00Z',featured:true}));
const pages=[
 ['homepage','Gemeinsam wird mehr möglich.','Eine starke Gemeinschaft beginnt mit Menschen, die füreinander da sind. Entdecke Anahita und die Möglichkeiten, gemeinsam etwas zu bewegen.'],
 ...
 ['membershipPage','Gemeinschaft mitgestalten','Eine Mitgliedschaft kann viele Möglichkeiten eröffnen, den Anahita zu unterstützen. Beiträge, Voraussetzungen und der verbindliche Antrag werden noch ergänzt.'],
 ...
 ['applicationPage','Zeit schenken. Ideen teilen.','Ob praktisch anpacken, zuhören oder neue Ideen entwickeln: Hier stellt der Anahita künftig bestätigte Möglichkeiten zum Mitmachen vor.'],
